...
export default async function EditVehiclePage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const updateVehicleWithId = editVehicle.bind(null, id);
    ...
    return (
        <div className="animate-fade-in" style={{ paddingBottom: "2rem" }}>
            ...
            <form action={updateVehicleWithId} className="glass-card" style={{ padding: "2rem", display: "flex", flexDirection: "column", gap: "2rem", maxWidth: "800px" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem", marginTop: "1.5rem" }}>
                        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                            ...
                            <input 
                                ...
                                type="date" 
                                defaultValue={vehicle.insuranceExpiry ? new Date(vehicle.insuranceExpiry).toISOString().split('T')[0] : ""}
                                style={{
                                    padding: "0.75rem 1rem",
                                    background: "var(--bg-tertiary)",
                                    border: "1px solid var(--border-color)",
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                            ...
                            <input 
                                ...
                                type="date" 
                                defaultValue={vehicle.serviceReminder ? new Date(vehicle.serviceReminder).toISOString().split('T')[0] : ""}
                                style={{
                                    padding: "0.75rem 1rem",
                                    background: "var(--bg-tertiary)",
                                    border: "1px solid var(--border-color)",
